...
function StoreBadge({
  ...
  return (
    <a
      ...
      className={
        "inline-flex h-[52px] items-center gap-2.5 rounded-xl px-4 transition-all duration-200 hover:-translate-y-0.5 hover:shadow-lg active:translate-y-0 active:shadow-md " +
        (variant === "dark"
